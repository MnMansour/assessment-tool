...
const StudentProfile = ({ account, user, peerUser }) => {
    return <div className="container">
        ...
        <div className="avatar">
            ...
            <div className="avatar-data">
                ...
                <div className="field">
                    <a href={account.githubAccount || "https://github.com"} className="github">
                        <i className="fab fa-github-square fa-2x" />
                    </a>
                    <a href={account.linkedinAccount || "https://www.linkedin.com"} className="linkedin">
                        <i className="fab fa-linkedin fa-2x" />
                    </a>
                    <a href={account.twitterAccount || "http://twitter.com/"} className="twitter">
