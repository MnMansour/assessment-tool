...
class SortableTable extends Component {
  ...
  handleSortDate = (sortBy, isReversed) => {
    const sorted = handleDate(
      Object.values(this.state.classes),
      sortBy,
      isReversed
    );
        ...
        <div className="head">
          ...
          <div className="title">
            ...
            <span className="head__span">
              <div
                onClick={() =>
                  this.handleSortNum("plannedSprints", true, this.dateSorter)
                }
                className="arrow-up"
              />
              <div
                onClick={() =>
                  this.handleSortNum("plannedSprints", false, this.dateSorter)
                }
                className="arrow-down"
              />
            </span>
